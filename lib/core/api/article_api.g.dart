...
class _ArticleApi implements ArticleApi {
  _ArticleApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ArticleDetailModel> getArticleBySlug(String slug) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ArticleDetailModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/article/${slug}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ArticleDetailModel _value;
    try {
      _value = ArticleDetailModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<TagModel>> getTags() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TagModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tag',
